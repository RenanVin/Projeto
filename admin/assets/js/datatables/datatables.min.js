...
oPaginate:{sFirst:"First",sLast:"Last",sNext:"<i class='fa fa-angle-right'></i>",sPrevious:"<i class='fa fa-angle-left'></i>"},sEmptyTable:"No data available in table",sInfo:"Exibindo _START_ a _END_ de _TOTAL_ registros",sInfoEmpty:"Showing 0 to 0 of 0 entries",sInfoFiltered:"(filtered from _MAX_ total entries)",sInfoPostFix:"",sDecimal:"",sThousands:",",sLengthMenu:"Mostrar _MENU_",sLoadingRecords:"Carregando...",sProcessing:"Processing...",sSearch:"Procurar:",sSearchPlaceholder:"",sUrl:"",sZeroRecords:"No matching records found"},oSearch:h.extend({},
