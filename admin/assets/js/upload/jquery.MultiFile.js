...
if (window.jQuery)(function ($) {
				...
				MultiFile.addToList = function (slave, slave_count, files) {
					...
					//$.each(files, function (i, file) {
						...
						var
							...
							b = $('<a class="MultiFile-remove btn btn-danger btn-sm" href="#' + MultiFile.wrapID + '"><span class="fa fa-trash-o"></span></a>')
	...
	*/
	$.fn.MultiFile.options = { //$.extend($.fn.MultiFile, { options: {
		accept: 'gif|jpg|png', // accepted file extensions
		max: 10, // maximum number of selectable files
		maxfile: 6100, // maximum size of a single file
		...
		STRING: {
			remove: 'x',
			denied: 'O formato $ext não pode ser enviado.',
			file: '$file',
			selected: 'Arquivo selecionado: $file',
			duplicate: 'Este arquivo já foi enviado:\n$file \n\n',
			toomuch: 'Os arquivos enviados excederam o limite de ($size)',
			toomany: 'Muitos arquivos selecionados (max: $max)',
			toobig: '$file é muito grande.'
		},
